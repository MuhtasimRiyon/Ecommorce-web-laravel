                            ...
                            <tbody>
                                @foreach($subcategory as $value)
                                    <tr>
                                        ...
                                        <td>{{ $value->subcategory_name_ban }}</td>
                                        <td>
                                            <a href="{{ route('Subcategory.edit',$value->id) }}" class="btn btn-info" title="Edit"><i class="fa fa-pencil-square-o"></i> Edit</a>
                                            <a href="{{ route('Subcategory.delete',$value->id) }}" class="btn btn-danger" title="Delete"><i class="fa fa-trash"></i> Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
