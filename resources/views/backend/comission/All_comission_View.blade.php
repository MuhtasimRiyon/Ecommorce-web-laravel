    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <div class="box">
                ...
                <form action="{{ route('all.comission') }}" method="post">
                            ...
                            <tbody>
                                ...
                                @foreach($commission as $key=>$value)
                                    ...
                                    <tr>
                                        ...
                                        <td> {{ $value->amount }} </td>
                                        <td>
                                            <a href="{{ route('commission.edit',$value->id) }}" class="btn btn-info" title="Edit"><i class="fa fa-pencil"></i> Edit</a>
                                            <a href="{{ route('commission.delete',$value->id) }}" class="btn btn-danger" title="Delete"><i class="fa fa-trash"></i> Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
