                  ...
                  <li class="yamm-content">
                    <div class="row">
                      ...
                      <div class="col-sm-12 col-md-3">
                        ...
                        @endphp
                        <!-- Get subsubcategory table end -->

                        @foreach($subsubcategory as $subsubcat)
                        <ul class="links list-unstyled">
                          <li><a href="#">
                            @if(session()->get('Language') == 'bangla' )
                            {{ $subsubcat->subsubcategory_name_ban }}
                            @else 
      ...
      <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder"> 
        ...
        <div id="hero">
          <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
            ...
            <div class="item" style="background-image: url({{ asset($sliderValue->slider_img) }});">
              <div class="container-fluid">
                <div class="caption bg-color vertical-center text-left">
                  <!-- <div class="slider-header fadeInDown-1">{{ $sliderValue->title }}</div> -->
                  <div class="big-text fadeInDown-1"> {{ $sliderValue->title }} </div>
                  <div class="excerpt fadeInDown-2 hidden-xs"> <span>{{ $sliderValue->description }}</span> </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-4 col-lg-4">
                <div class="info-box">
                  ...
                  <h6 class="text">
                    @if(session()->get('Language') == 'bangla' )
                    {{ $inbox->infobox_description_ban }}
                    @else 
                    {{ $inbox->infobox_description }}
                    @endif
                  </h6>
                </div>
              </div>
                ...
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{ asset($pro->product_thambnail) }}" alt=""></a> </div>
                          <!-- /.image -->

                          @php
                          $amount = $pro->selling_price - $pro->discount_price;
                          $persentage = ($amount/$pro->selling_price)*100;
                          @endphp
                          ...
                          <div>
                            ...
                            @else
                            <div class="tag sale"><span>{{ round($persentage) }}%</span></div>
                            @endif
                          </div>
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="{{ url('product/details/' . $pro->id . '/' . $pro->product_slug_en) }}">
                            @if(session()->get('Language') == 'bangla' )
                            {{ $pro->product_name_ban }}
                            @else 
                            {{ $pro->product_name_en }}
                            @endif
                          </a></h3>
                          ...
                          <!-- /.product-price -->
                            ...
                            @if($pro->discount_price == NULL)
                            <div class="product-price"> <span class="price"> TK {{ $pro->selling_price }} </span></div>
                            @else
                            <div class="product-price"> <span class="price"> TK {{ $pro->discount_price }} </span> <span class="price-before-discount">TK {{ $pro->selling_price }}</span> </div>
                            @endif
